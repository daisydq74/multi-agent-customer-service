...
class CustomerDataAgent:
    ...
    def fetch_customer(self, customer_id: int) -> ToolResult:
        self.log.record("router", self.name, f"Get customer info for ID {customer_id}")
    ...
    def update_customer(self, customer_id: int, data: Dict[str, Any]) -> ToolResult:
        ...
        self.log.record("router", self.name, f"Update result: {result.result}")
        return result

    def history(self, customer_id: int) -> ToolResult:
        self.log.record("router", self.name, f"Get history for customer {customer_id}")
